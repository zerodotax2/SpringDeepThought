package ru.projects.prog_ja.services.files.fileServices.docs;
...
public class DocsFileService extends AbstractFileService {
    ...
    public ResponseEntity<?> doUpload(MultipartFile file, String uploadPath, String extension, String userID) {
        ...
        try (InputStream is = file.getInputStream()) {
            ...
            String relativePath = writeFile(fileAndDirectory, uploadPath, "docs", os.toByteArray());

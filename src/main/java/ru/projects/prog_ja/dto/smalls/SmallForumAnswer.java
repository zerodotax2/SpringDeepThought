...
public class SmallForumAnswer {
    ...
    public SmallForumAnswer() {
    }

    public SmallForumAnswer(long id, String text, Date createDate, SmallUserTransfer user) {
        this.id = id;
        this.text = text;
    ...
    public SmallForumAnswer(long id, String text, Date createDate,
